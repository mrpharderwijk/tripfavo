...
export default async function GuestReservationRequestSendEmailTemplate(props: EmailGuestReservationRequestProps) {
  ...
  return <EmailHostReservationRequest {...props} startDate={startDate} endDate={endDate} guestsAmount={guestsAmount} listing={listing as unknown as PublicListing} guest={guest} locale={locale} />
}
