...
export function SignUpForm(): ReactElement {
  const { control, onSubmit, handleSubmit, errors, isLoading, error } = useSignUpForm()
    ...
    >
      ...
      <Box display="flex" flex-direction="col" gap={6} padding={8}>
          ...
          <FlexBox flex-direction="col" gap={4}>
            <FlexBox flex-direction="col" gap={3}>
              ...
              <Controller
                ...
                control={control}
                rules={{
                  required: tCommon('forms.required', { field: tCommon('forms.firstName.label') }),
                }}
                render={({ field }) => (
                  <Input
                    id="name"
              ...
              <Controller
                ...
                control={control}
                rules={{
                  required: tCommon('forms.required', { field: tCommon('forms.lastName.label') }),
                }}
                render={({ field }) => (
                  <Input
                    id="name"
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <NextLink href={routes.login.path} passHref>
            <Body
              tag="span"
              font-size="base-md"
              text-color="primary"
