...
export function PropertiesList({
  ...
  console.log(
    'PropertiesList received properties:',
    properties?.length,
    properties,
  )
  ...
  const getValidImageUrl = (property: PublicProperty): string => {
  ...
  try {
                ...
                <FlexBox flex-direction="row" gap={2} align-items="center">
                  <FlexBoxItem display="flex" flex-direction="row" gap={1}>
                    <Body size="base-md" color="secondary" text-align="left">
                      &euro;{' '}
                      {property.priceDetails.length > 0
                        ? property.priceDetails[0]?.price || 0
                        : 0}
                    </Body>
                    <Body size="base-md" color="secondary" text-align="left">
                      per night
    ...
    console.error('Error rendering PropertiesList:', error)
    return (
      <section className="w-full">
