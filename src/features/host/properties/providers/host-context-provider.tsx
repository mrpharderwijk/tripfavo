...
import { AmenitiesForm } from '@/features/host/properties/host-property-detail-funnel/components/forms/amenities-form/amenities-form'
import { DescriptionForm } from '@/features/host/properties/host-property-detail-funnel/components/forms/description-form/description-form'
import {
  FloorPlanForm,
  FloorPlanFormSchema,
} from '@/features/host/properties/host-property-detail-funnel/components/forms/floor-plan-form/floor-plan-form'
import { GuestsAmountForm } from '@/features/host/properties/host-property-detail-funnel/components/forms/guests-amount-form/guests-amount-form'
import {
  ImagesForm,
  ImagesFormSchema,
} from '@/features/host/properties/host-property-detail-funnel/components/forms/images-form/images-form'
import {
  LocationForm,
  LocationFormSchema,
} from '@/features/host/properties/host-property-detail-funnel/components/forms/location-form/location-form'
import { NeighbourhoodDescriptionForm } from '@/features/host/properties/host-property-detail-funnel/components/forms/neighbourhood-description-form/neighbourhood-description-form'
import { PriceForm } from '@/features/host/properties/host-property-detail-funnel/components/forms/price-form/price-form'
import {
  PrivacyTypeForm,
  PrivacyTypeFormSchema,
} from '@/features/host/properties/host-property-detail-funnel/components/forms/privacy-type-form/privacy-type-form'
import {
  StructureForm,
  StructureFormSchema,
} from '@/features/host/properties/host-property-detail-funnel/components/forms/structure-form/sturcture-form'
import { TitleForm } from '@/features/host/properties/host-property-detail-funnel/components/forms/title-form/title-form'
...
export function HostContextProvider({
  ...
  function onPreviousStep(): void {
    if (currentStepNumber > 0) {
      ...
      if (previousStepKey) {
        router.push(
          `/host/properties/${propertyId}/${stepMap[previousStepKey as HOST_STEP].url}`,
        )
      }
    }
  }
    ...
    if (currentStepNumber < Object.keys(steps).length - 1) {
      ...
      if (currentStepObject.form) {
        ...
        if (
          ...
          if (formSubmit) {
            router.push(
              `/host/properties/${propertyId}/${stepMap[nextStepKey as HOST_STEP].url}`,
            )
            return
          }
        }
    ...
    if (
      ...
      if (currentStepObject.form) {
        ...
        if (
          ...
          if (formSubmit) {
            const overviewStepPath = getRoutePathByRouteName('hostProperties')
